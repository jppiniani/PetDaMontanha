...
export default function Contato(){
    return(
        ...
        <div className = "boardTexto5"> {/*Esse css está no css do sobre. Lá eu explico o porquê*/}
        <h2 className="titulo">Nossa localização!</h2>  
        </div>
        <div className="boardMap"> {/*Esse css está no css do sobre. Lá eu explico o porquê*/}
        <iframe
